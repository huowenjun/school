...
function stuCardInfo(){
  var url = '/index.php/Api/Counts/stuCardInfoT';
...
function stuCardAreaInfo(){
  var url = '/index.php/Api/Counts/stuCardAreaInfoT';
  fget(url,'',function(res){
    if(g_loadingIndex > -1) dialog.closeLoding(g_loadingIndex);
    g_loadingIndex = -1;
    if(res.status==1){
...
function attendanceInfo(){
  var url = '/index.php/Api/Counts/attendanceInfoT';
  fget(url,'',function(res){
    if(g_loadingIndex > -1) dialog.closeLoding(g_loadingIndex);
    g_loadingIndex = -1;
    if(res.status==1){
...
//APP 用户数及在线数接口调用
function userInfo(){
  var url = '/index.php/Api/Counts/userInfoT';
  fget(url,'',function(res){
    if(g_loadingIndex > -1) dialog.closeLoding(g_loadingIndex);
    g_loadingIndex = -1;
    if(res.status==1){
...
function getAppCounts(){
  var url = '/index.php/Api/Counts/getAppCountsT';
  fget(url,'',function(res){
    if(g_loadingIndex > -1) dialog.closeLoding(g_loadingIndex);
    g_loadingIndex = -1;
    if(res.status==1){
...
function getAppModuleCounts(){
  var url = '/index.php/Api/Counts/getAppModuleCountsT';
  fget(url,'',function(res){
    if(g_loadingIndex > -1) dialog.closeLoding(g_loadingIndex);
    g_loadingIndex = -1;
    if(res.status==1){
...
function getChatCounts(){
  var url = '/index.php/Api/Counts/getChatCountsT';
  fget(url,'',function(res){
    if(g_loadingIndex > -1) dialog.closeLoding(g_loadingIndex);
    g_loadingIndex = -1;
    if(res.status==1){
...
function stuCardBillCounts(){
  var url = '/index.php/Api/Counts/stuCardBillCountsT';
  fget(url,'',function(res){
    if(g_loadingIndex > -1) dialog.closeLoding(g_loadingIndex);
    g_loadingIndex = -1;
    if(res.status==1){
