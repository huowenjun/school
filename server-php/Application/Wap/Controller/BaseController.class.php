...
class BaseController extends Controller
{
    ...
    protected function init()
    {
        ...
        if ('Login' <> $login) {
            ...
            // $this->checkAuth();
            //           $auth= new \Think\Auth();
//            if(!$auth->check('/'.MODULE_NAME.'/'.CONTROLLER_NAME.'/'.ACTION_NAME,session('admin_user')['user_id'])){
//                $this->error('你没有权限');
//            }
        }
        if ($this->getUserId()) {
                                                        ...
                                                        foreach ($classList as $key6 => $value6) {
                                                            ...
                                                            if ($param != 'class') {//显示到班级
                                                                ...
                                                                foreach ($studentList as $key7 => $value7) {
                                                                    ...
                                                                    $arr[$key]['children'][$key1]['children'][$key2]['children'][$key3]['children'][$key4]['children'][$key5]['children'][$key6]['children'][$key7]['name'] = "{$value7['stu_name']}";
                                                ...
                                                foreach ($classList as $key6 => $value6) {
                                                    ...
                                                    if ($param != 'class') {
                                                        ...
                                                        foreach ($studentList as $key7 => $value7) {
                                                            ...
                                                            $arr[$key1]['children'][$key2]['children'][$key3]['children'][$key4]['children'][$key5]['children'][$key6]['children'][$key7]['name'] = "{$value7['stu_name']}";
                                        ...
                                        foreach ($classList as $key6 => $value6) {
                                            ...
                                            if ($param != 'class') {
                                                ...
                                                foreach ($studentList as $key7 => $value7) {
                                                    ...
                                                    $arr[$key2]['children'][$key3]['children'][$key4]['children'][$key5]['children'][$key6]['children'][$key7]['name'] = "{$value7['stu_name']}";
