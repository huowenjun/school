        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab1" data-toggle="tab">校区管理</a></li>
            </ul>
                ...
                <nav class="navbar navbar-default">
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="form-inline navbar-form navbar-left">
                      <div class="form-group">
                        <label for="keyword1">校区名称：</label>
                        <input id="keyword1" type="text" class="form-control input-sm" placeholder="请输入校区名称" />
                      </div>
                      <div class="form-group">
                      ...
                      <table id="table_data" class="js-custom-table-data">
                        <thead>
                          <tr>
                            ...
                            <th data-align="center" data-sortable="true" data-field="name" name="">校区名称</th>
  ...
  <div class="modal-body">
    <div class="container-fluid">
      <form class="form-horizontal" action="" method="post" onsubmit="return false" id="formWindow">
        <input class="primaryKey" type="hidden" name="a_id" id="a_id" />
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-group">
              <label class="col-md-3 control-label" for="name"><span class="xing">*</span> 校区名称：</label>
              <div class="col-md-8">
                <input type="text" placeholder="校区名称" id="name" name="name" class="form-control" />
              </div>
            </div>
            <div class="form-group">
...
<form id="searchForm" name="searchForm" action="" style="position: fixed; top: 0; right: 0; z-index: 99999;">
  ...
  <input type="hidden" id="keyword" name="keyword" value="" placeholder="校区" />
</form>
...
$(function() {
  ...
  function zTreeOnClick(event, treeId, treeNode) {
    ...
    search();
    // 是否选择了学校
    if ($(".s_id_hide").val() != '' && $(".a_id_hide").val() == '') {
      bIfCheckSchool = true;
    } else {
      bIfCheckSchool = false;
    };
  }
  // 点击添加
  $('.select_add').click(function() {
    if ($(".s_id_hide").val() != '' && $(".a_id_hide").val() == '' && bIfCheckSchool) {
      $('.primaryKey').val('0');
      edit(0);
    } else {
      dialog.error('请选择学校！');
...
function ajaxRequest(params) {
  ...
  searchForm();
  // 需要的数据
  var url = "/index.php/Admin/School/SchArea/query?" + $("#searchForm").serialize();
...
//新增/编辑
function edit(id) {
  var url = g_config.host + '/index.php/Admin/School/SchArea/get';
  custom_edit(id,url,{a_id:id},'formWindow','modalWindow');
}

//保存数据
function save() {
  var url = g_config.host + '/index.php/Admin/School/SchArea/edit';
  fpost(url,'formWindow',btnCallbackRefreshTable1);
}

//删除
function del() {
  var url    = g_config.host + "/index.php/Admin/School/SchArea/del";
  var ids    = getIdSelections($('.js-custom-table-data'),'a_id');
  var strIds = ids.join(',');
  var data   = {};
  data.a_id  = strIds;
