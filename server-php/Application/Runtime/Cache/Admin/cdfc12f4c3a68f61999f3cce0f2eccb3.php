              ...
              <div class="box-body chat" id="chat-box">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="container-fluid">
                      ...
                      <form class="" action="" method="get" id="WirelessConfigForm">
                        ...
                        <div class="form-inline navbar-form navbar-left">
                          <?php if(($userType != 4)): ?><div class="form-group">
                            <label for="campus1">提问人：</label>
                            <select id="campus" name="campus" class="form-control input-sm">
                              <option value="">选择提问人</option>
                              <?php if(is_array($sendName)): foreach($sendName as $k=>$v): ?><option value="<?php echo ($v['send_user']); ?>" <?php if(($campus == $v['send_user'])): ?>selected<?php endif; ?>><?php echo ($v['name']); ?></option><?php endforeach; endif; ?>
                            </select>
                          </div><?php endif; ?>
                          <div class="form-group">
                            <label for="stime1">时间段：</label>
                            <input id="stime1" name="stime" class="form-control input-sm dataTime" placeholder="" type="text" value="<?php echo ($sdate); ?>" />
                            <span>-</span>
                            <input id="etime1" name="etime" class="form-control input-sm dataTime" placeholder="" type="text" value="<?php echo ($edate); ?>" />
                          </div>
                          <div class="form-group">
                    ...
                    <?php if(is_array($result)): foreach($result as $k=>$v): ?><div class="user-block item">
                        <img class="img-circle" src="/Public/dist/img/users.png" alt="User Image">
                        <div class="username">
                          <a href="/index.php/Admin/Parent/Online/details.html?id=<?php echo ($v['id']); ?>"><?php echo ($v['title']); ?></a>
                        </div>
                        <div class="description"><?php echo ($v['create_time']); ?></div>
                        <div class="message">
                          <div class="text">
                        ...
                        <div class="direct-chat-info clearfix">
                          <span class="direct-chat-timestamp pull-left"><?php echo (get_user_name($v['send_user'])); ?></span>
                        </div>
                      </div><hr /><?php endforeach; endif; ?>
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
