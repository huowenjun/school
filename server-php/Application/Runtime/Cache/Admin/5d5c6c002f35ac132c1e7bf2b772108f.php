        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab1" data-toggle="tab">作业管理</a></li>
            </ul>
                ...
                <nav class="navbar navbar-default">
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="form-inline navbar-form navbar-left">
                      ...
                      <div class="form-group">
                        <label class="control-label" for="crs_id0001">学科：</label>
                        <input id="crs_id0001" type="text" class="form-control input-sm" placeholder="" />
                        <!-- <select id="crs_id1" class="form-control input-sm crs_id1"></select> -->
                      </div>
                      <div class="form-group">
                      ...
                      <table id="table_data" class="js-custom-table-data">
                        <thead>
                          <tr>
                            ...
                            <th data-align="center" data-formatter="operateFormatter" data-events="detailsOperateEvents" name="operateFormatter">操作</th>
                            <th data-align="center" data-formatter="viewFormatter" data-events="detailsOperateEvents" name="viewFormatter">操作</th>
                            ...
                            <th data-align="center" data-sortable="false" data-field="crs_id" name="">学科</th>
                            <th data-align="center" data-sortable="false" data-field="name" name="">作业名称</th>
                            <th data-align="center" data-sortable="false" data-visible="0" data-field="work_content" name="">作业内容</th>
                            <th data-align="center" data-sortable="true" data-field="create_time" name="">布置时间</th>
                            <th data-align="center" data-sortable="true" data-field="finish_time" name="">需完成时间</th>
                          </tr>
                        </thead>
                      </table>
                    </div>
  ...
  <div class="modal-body">
    <div class="container-fluid">
      <form class="form-horizontal" action="" method="post" onsubmit="return false" id="formWindow">
        <input class="primaryKey" type="hidden" name="h_id" id="h_id" />
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label class="col-md-3 control-label" for="name"><span class="xing">*</span> 作业名称：</label>
                  <div class="col-md-8">
                    <input type="text" id="name" name="name" class="form-control" placeholder="作业名称" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-3 control-label" for="work_content"><span class="xing">*</span> 作业内容：</label>
                  <div class="col-md-8">
                    <textarea id="work_content" name="work_content" class="form-control" placeholder="最多输入250个字..."></textarea>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label class="col-md-3 control-label" for="finish_time"><span class="xing">*</span> 需完成时间：</label>
                  <div class="col-md-8">
                    <input type="text" id="finish_time" name="finish_time" class="form-control dataTime" placeholder="需完成时间" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-3 control-label" for="crs_id"><span class="xing">*</span> 学科：</label>
                  <div class="col-md-8">
                    <select id="crs_id" name="crs_id" class="form-control crs_id"></select>
                  </div>
                </div>
              </div>
            </div>
...
<!-- 详情 弹出层 -->
<div class="shade" style="" id="modalWindowDetail">
  <div class="modal-body">
    <div class="container-fluid">
      <div class="form-horizontal" id="formWindowDetail">
        <div class="row">
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label class="col-md-2 control-label" for="name">作业名称：</label>
                  <div class="col-md-9">
                    <input type="text" id="name1" name="name" class="form-control" placeholder="作业名称" readonly />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label" for="crs_id">学科：</label>
                  <div class="col-md-9">
                    <input type="text" id="crs_id1" name="crs_id" class="form-control" placeholder="学科" readonly />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label" for="finish_time">需完成时间：</label>
                  <div class="col-md-9">
                    <input type="text" id="finish_time1" name="finish_time" class="form-control dataTime" placeholder="需完成时间" readonly />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label" for="work_content">作业内容：</label>
                  <div class="col-md-9">
                    <textarea id="work_content1" name="work_content" class="form-control" placeholder="最多输入250个字..." readonly></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label" for="">语音播放：</label>
                  <div class="col-md-2">
                    <p class="form-control js_audioTxt" style="border: none; padding: 7px 0; color: red; display: none">无语音播放</p>
                    <button name="" class="form-control btn btn-sm btn-primary js_audio" style="display: none"><span class="fa fa-caret-square-o-right"></span> 点击播放</button>
                    <input type="hidden" id="audioUrl" name="" value="" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label" for="img">作业图片：</label>
                  <div class="col-md-9">
                    <p class="form-control js_imgTxt" style="border: none; padding: 7px 0; color: red; display: none">无作业图片</p>
                    <img id="img" name="img" src="" alt="" style="width: 100%" />
                  </div>
                </div>
              </div>
            </div>
...
<!-- 音频播放 -->
<script type="text/javascript" src="/Public/dist/js/voice-2.0.js"></script>
...
window.detailsOperateEvents = {
  ...
  'click .view': function (e, value, row, index) {
    ...
    var key = Object.keys(row)[0]; // 主键第一个值
    detailGet(row[key]);
    $.get('/index.php/Admin/Parent/Homework/detailGet?h_id='+row.h_id, function(data) {
      if (data.data.img == '') {
        $('.js_imgTxt').css('display', 'block');
        $('#img').attr('src', '');
      } else {
        $('.js_imgTxt').css('display', 'none');
        $('#img').attr('src', data.data.img);
      };
      if (data.data.audio == '') {
        $('.js_audio').css('display', 'none');
        $('.js_audioTxt').css('display', 'block');
      } else {
        $('.js_audio').css('display', 'block');
        $('.js_audioTxt').css('display', 'none');
        $('#audioUrl').val(data.data.audio);
      };
    });
  }
}
...
$('.js_audio').click(function() {
  RongIMLib.RongIMVoice.play($('#audioUrl').val());
...
$(function() {
  ...
  $('.select_add').click(function() {
    if ($(".c_id_hide").val() != '' && bIfCheckClass) {
      ...
      initSelectClass('crs_id',g_config.host+'/index.php/Admin/Parent/Homework/getList?g_id=' + g_id,0,{type:'course'},true); // 学科
    } else {
      dialog.error('请选择班级！');
    };
  })
...
function searchForm() {
  ...
  $("#crs_id_hide").val($("#crs_id0001").val());
}
...
function ajaxRequest(params) {
  ...
  searchForm();
  // 需要的数据
  var url = "/index.php/Admin/Parent/Homework/query?" + $("#searchForm").serialize();
...
// 新增/编辑
function edit(id) {
  var url = g_config.host + '/index.php/Admin/Parent/Homework/get';
  custom_edit(id,url,{h_id:id},'formWindow','modalWindow',function(res) {
    var g_id   = res.data.g_id;
    var crs_id = res.data.crs_id;
    initSelectClass('crs_id',g_config.host+'/index.php/Admin/Parent/Homework/getList?g_id=' + g_id,0,{type:'course'},false,'undefined',function(){
      $('#crs_id').val(crs_id);
    }); // 学科
  });
}
...
function detailGet(id) {
  var url = g_config.host + '/index.php/Admin/Parent/Homework/detailGet?h_id='+id;
  custom_viewDetails(id,url,{id:id},'formWindowDetail','modalWindowDetail');
}

// 保存数据
function save() {
  var url = g_config.host + '/index.php/Admin/Parent/Homework/edit';
  fpost(url,'formWindow',btnCallbackRefreshTable1);
}

// 删除
function del() {
  var url    = g_config.host + "/index.php/Admin/Parent/Homework/del";
  var ids    = getIdSelections($('.js-custom-table-data'),'h_id');
  var strIds = ids.join(',');
  var data   = {};
  data.id    = strIds;
