        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab1" data-toggle="tab">年级管理</a></li>
            </ul>
                ...
                <nav class="navbar navbar-default">
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="form-inline navbar-form navbar-left">
                      <div class="form-group">
                        <label for="keyword1">年级名称：</label>
                        <input id="keyword1" type="text" class="form-control input-sm" placeholder="请输入年级名称" />
                      </div>
                      <div class="form-group">
                      ...
                      <table id="table_data" class="js-custom-table-data">
                        <thead>
                          <tr>
                            ...
                            <th data-align="center" data-sortable="true" data-field="name" name="">年级名称</th>
  ...
  <div class="modal-body">
    <div class="container-fluid">
      <form class="form-horizontal" action="" method="post" onsubmit="return false" id="formWindow">
        <input class="primaryKey" type="hidden" name="g_id" id="g_id" />
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-group">
              <label class="col-md-3 control-label" for="name"><span class="xing">*</span> 年级名称：</label>
              <div class="col-md-8">
                <input type="text" placeholder="年级名称" id="name" name="name" class="form-control" />
              </div>
            </div>
            <div class="form-group">
...
function ajaxRequest(params) {
  ...
  searchForm();
  // 需要的数据
  var url = "/index.php/Admin/School/Grade/query?" + $("#searchForm").serialize();
...
//新增/编辑
function edit(id) {
  var url = g_config.host + '/index.php/Admin/School/Grade/get';
  custom_edit(id,url,{g_id:id},'formWindow','modalWindow');
}

//保存数据
function save() {
  var url = g_config.host + '/index.php/Admin/School/Grade/edit';
  fpost(url,'formWindow',btnCallbackRefreshTable1);
}

//删除
function del() {
  var url    = g_config.host + "/index.php/Admin/School/Grade/del";
  var ids    = getIdSelections($('.js-custom-table-data'),'g_id');
  var strIds = ids.join(',');
  var data   = {};
  data.id    = strIds;
