        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab1" data-toggle="tab">评语管理</a></li>
            </ul>
                ...
                <nav class="navbar navbar-default">
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="form-inline navbar-form navbar-left">
                      ...
                      <div class="form-group">
                        <label class="control-label" for="r_type1">评语类型：</label>
                        <select id="r_type1" class="form-control input-sm">
                          <option value="">选择评语类型</option>
                          <option value="1">平时评语</option>
                          <option value="2">每周评语</option>
                          <option value="3">每月评语</option>
                          <option value="4">期中评语</option>
                          <option value="5">期末评语</option>
                        </select>
                      </div>
                      <div class="form-group">
                      ...
                      <table id="table_data" class="js-custom-table-data">
                        <thead>
                          <tr>
                            ...
                            <th data-align="center" data-sortable="false" data-field="r_type" name="">评语类型</th>
                            <th data-align="center" data-sortable="false" data-visible="0" data-field="content" name="">评语内容</th>
                            <th data-align="center" data-sortable="true" data-field="create_time" name="">发表时间</th>
  ...
  <div class="modal-body">
    <div class="container-fluid">
      <form class="form-horizontal" action="" method="post" onsubmit="return false" id="formWindow">
        <input class="primaryKey" type="hidden" name="r_id" id="r_id" />
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label class="col-md-3 control-label" for="r_type"><span class="xing">*</span> 评语类型：</label>
                  <div class="col-md-8">
                ...
                <div class="form-group">
                  <label class="col-md-3 control-label" for="content"><span class="xing">*</span> 评语内容：</label>
                  <div class="col-md-8">
                    <textarea class="form-control" id="content" name="content" maxlength="250" placeholder="最多输入250个字..."></textarea>
                  </div>
                </div>
              </div>
            </div>
...
<form id="searchForm" name="searchForm" action="" style="position: fixed; top: 0; right: 0; z-index: 99999;">
  ...
  <input type="hidden" id="r_type_hide" name="r_type" value="" />
</form>
...
function ajaxRequest(params) {
  ...
  searchForm();
  // 需要的数据
  var url = "/index.php/Admin/Parent/Comment/query?" + $("#searchForm").serialize();
...
//新增/编辑
function edit(id) {
  var url = g_config.host + '/index.php/Admin/Parent/Comment/get';
  custom_edit(id,url,{r_id:id},'formWindow','modalWindow');
}

//保存数据
function save() {
  var url = g_config.host + '/index.php/Admin/Parent/Comment/edit';
  fpost(url,'formWindow',btnCallbackRefreshTable1);
}

//删除
function del() {
  var url    = g_config.host + "/index.php/Admin/Parent/Comment/del";
  var ids    = getIdSelections($('.js-custom-table-data'),'r_id');
  var strIds = ids.join(',');
  var data   = {};
  data.id    = strIds;
