                ...
                <nav class="navbar navbar-default">
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="form-inline navbar-form navbar-left">
                      <div class="form-group">
                        <label for="keyword1">班级名称：</label>
                        <input id="keyword1" type="text" class="form-control input-sm" placeholder="请输入班级名称" />
                      </div>
                      <div class="form-group">
                      ...
                      <table id="table_data" class="js-custom-table-data">
                        <thead>
                          <tr>
                            ...
                            <th data-align="center" data-formatter="editFormatter" data-events="operateEvents02" name="editFormatter">操作</th>
                            <th data-align="center" data-sortable="true" data-field="name" name="">班级名称</th>
                            <th data-align="center" data-sortable="false" data-field="g_id" name="">所属年级</th>
                            <th data-align="center" data-sortable="false" data-field="a_id" name="">所属校区</th>
                            <th data-align="center" data-sortable="false" data-field="t_id" name="">班主任</th>
  ...
  <div class="modal-body">
    <div class="container-fluid">
      <form class="form-horizontal" action="" method="post" onsubmit="return false" id="formWindow">
        <input class="primaryKey" type="hidden" name="c_id" id="c_id" />
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-group">
              <label class="col-md-3 control-label" for="name"><span class="xing">*</span> 班级名称：</label>
              <div class="col-md-8">
                <input type="text" placeholder="班级名称" id="name" name="name" class="form-control" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-3 control-label" for="t_id"><span class="xing">*</span> 班主任：</label>
              <div class="col-md-8">
                <select id="t_id" name="t_id" class="form-control t_id1"></select>
              </div>
            </div>
            <div class="form-group">
...
if (user_type == '3') {
  $('.select_add, #remove, th[data-checkbox="true"], th[data-formatter="editFormatter"]').remove();
}
...
$(function() {
  ...
  $.ajax({
    type: "get",
    url: "/index.php/Admin/index/get_tree?type=grade",
    dataType : 'json',
  ...
  $('.select_add').click(function() {
    if ($(".g_id_hide").val() != '' && bIfCheckGrade) {
      $('.primaryKey').val('0');
      edit(0);
      var a_id = $('.a_id_hide').val();
      initSelectClass('t_id1',g_config.host+'/index.php/Admin/School/Class/get_list?a_id=' + a_id,0,{type:'teacher'},false,'undefined',function(){}); // 老师
    } else {
      dialog.error('请选择年级！');
    };
  })
...
function ajaxRequest(params) {
  ...
  searchForm();
  // 需要的数据
  var url = "/index.php/Admin/School/Class/query?" + $("#searchForm").serialize();
...
//新增/编辑
function edit(id) {
  var url = g_config.host + '/index.php/Admin/School/Class/get';
  custom_edit(id,url,{c_id:id},'formWindow','modalWindow');
}

//保存数据
function save() {
  var url = g_config.host + '/index.php/Admin/School/Class/edit';
  fpost(url,'formWindow',btnCallbackRefreshTable1);
}

//删除
function del() {
  var url    = g_config.host + "/index.php/Admin/School/Class/del";
  var ids    = getIdSelections($('.js-custom-table-data'),'c_id');
  var strIds = ids.join(',');
  var data   = {};
  data.id    = strIds;
