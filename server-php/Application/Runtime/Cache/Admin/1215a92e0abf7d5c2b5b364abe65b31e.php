                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8 control-div">
                        <input type="text" class="form-control js_val" id="name" name="name" placeholder="学校名称" />
                        <div class="js_txt txt"></div>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="main_zrr" class="col-sm-4 control-label"><span class="xing">*</span> 主负责人：</label>
                      <div class="col-sm-8 control-div">
                        <input type="text" class="form-control js_val" id="main_zrr" name="main_zrr" placeholder="主负责人" />
                        <div class="js_txt txt"></div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-8 control-div">
                        <input type="text" class="form-control js_val" id="sub_zzr" name="sub_zzr" placeholder="副负责人" />
                        <div class="js_txt txt"></div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-8 control-div">
                        <input type="text" class="form-control js_val" id="tel" name="tel" placeholder="格式：0427-43275670 或 010-23237788" />
                        <div class="js_txt txt"></div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-8 control-div">
                        <textarea class="form-control js_val" id="memo" name="memo" placeholder="最多输入200字！" maxlength="200"></textarea>
                        <div class="js_txt txt"></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8 control-div">
                        <input type="text" class="form-control dataTime js_val" id="build_time" name="build_time" placeholder="成立时间" />
                        <div class="js_txt txt"></div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-8 control-div">
                        <input type="text" class="form-control js_val" id="main_phone" name="main_phone" placeholder="主负责人电话" />
                        <div class="js_txt txt"></div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-8 control-div">
                        <input type="text" class="form-control js_val" id="sub_phone" name="sub_phone" placeholder="副负责人电话" />
                        <div class="js_txt txt"></div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-8 control-div">
                        <input type="text" class="form-control js_val" id="address" name="address" placeholder="地址" />
                        <div class="js_txt txt"></div>
                      </div>
                    </div>
                  </div>
