...
class SDKConfig {
	...
	function __construct(){
		...
		foreach($ini_array as $key=>$value){
			$ini_array[$key]['acpsdk.signCert.path'] = __DIR__.'/certs/acp_test_sign.pfx';
			$ini_array[$key]['acpsdk.encryptCert.path'] =__DIR__.'/certs/acp_test_enc.cer';
			$ini_array[$key]['acpsdk.middleCert.path'] =__DIR__.'/certs/acp_test_middle.cer';
			$ini_array[$key]['acpsdk.rootCert.path'] = __DIR__.'/certs/acp_test_root.cer';
		}
